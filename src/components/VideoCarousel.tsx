...
const VideoCarousel = () => {
    ...
    const [loadedData, setLoadedData] = useState<videoModel[]>([]);
    ...
    const handleLoadedMetaData = (_i: number, e: SyntheticEvent<HTMLVideoElement>) => setLoadedData((pre: any) => [...pre, e]);
                        ...
                        <div className="video-carousel_container">
                            <div className="w-full h-full flex-center rounded-3xl overflow-hidden bg-black">
                                <video
                                    ...
                                    onLoadedMetadata={(e : SyntheticEvent<HTMLVideoElement>) => handleLoadedMetaData(i, e)}
                                >
