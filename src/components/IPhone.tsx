...
Command: npx gltfjsx@6.5.2 .\scene.glb -t -o IPhone
...
interface Item {
    img: string;
    color: string[]; // Update to string[] if the array has more than one color
}

// Define ModelProps using intersection types
interface ModelProps {
    item: Item;
    size: String;
}

type ModelPropsWithGroup = ModelProps & JSX.IntrinsicElements['group'];

function Model(props: ModelPropsWithGroup) {
