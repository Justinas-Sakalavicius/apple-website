...
const Lights = () => {
    return (
        // Group different lights and light formers. We can use a group to organize lights, cameras, meshes, and other objects in the scene.
        <group name="lights">
            {/**
            ...
            <Environment resolution={256}>
                <group>
                    {/**
                     * @description Light former used to create custom lights with various shapes and properties in a 3D scene.
